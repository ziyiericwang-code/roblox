...
export const CAMOS = {
  ...
  night: { id: 'night', name: 'Night Ops', price: 1100, minRank: 5, colors: ['#23282f', '#343b44', '#191c21'] },
  ...
  dress: { id: 'dress', name: 'Officer Dress', price: 0, minRank: 11, colors: ['#3c4a3a', '#34402f', '#46553f'] },
  command: { id: 'command', name: 'High Command', price: 0, minRank: 17, colors: ['#3a3f47', '#2c3036', '#4a515b'] },
...
export const HEADGEAR = {
  ...
  beret: { id: 'beret', name: 'Officer Beret', price: 0, minRank: 11 },
  cap: { id: 'cap', name: 'General\'s Cap', price: 0, minRank: 17 },
};
