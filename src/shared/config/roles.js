...
export const ROLES = {
  ...
  engineer: {
    id: 'engineer', name: 'Engineer', icon: 'E', minRank: 3, perSquad: 2,
  ...
  support: {
    id: 'support', name: 'Support', icon: 'S', minRank: 3, perSquad: 2,
  ...
  scout: {
    id: 'scout', name: 'Scout', icon: 'Sc', minRank: 4, perSquad: 1,
  ...
  leader: {
    id: 'leader', name: 'Squad Leader', icon: 'SL', minRank: 5, perSquad: 1, leaderOnly: true,
    primaries: ['ar7', 'br4'], sidearms: ['p9', 'r45'],
